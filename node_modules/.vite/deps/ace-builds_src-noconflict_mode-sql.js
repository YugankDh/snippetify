...
var require_mode_sql = __commonJS({
  "node_modules/ace-builds/src-noconflict/mode-sql.js"(exports, module) {
    ace.define("ace/mode/sql_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      ...
      exports2.SqlHighlightRules = SqlHighlightRules;
    });
    ...
    ace.define("ace/mode/sql", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/sql_highlight_rules", "ace/mode/folding/sql"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var SqlHighlightRules = require2("./sql_highlight_rules").SqlHighlightRules;
      var SqlFoldMode = require2("./folding/sql").FoldMode;
      var Mode = function() {
...
export default require_mode_sql();
//# sourceMappingURL=ace-builds_src-noconflict_mode-sql.js.map
