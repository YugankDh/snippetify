...
var require_mode_markdown = __commonJS({
  "node_modules/ace-builds/src-noconflict/mode-markdown.js"(exports, module) {
    ...
    ace.define("ace/mode/folding/markdown", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../../lib/oop");
    ...
    ace.define("ace/mode/sh", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/sh_highlight_rules", "ace/range", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
    ...
    ace.define("ace/mode/markdown", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour/cstyle", "ace/mode/text", "ace/mode/markdown_highlight_rules", "ace/mode/folding/markdown", "ace/mode/javascript", "ace/mode/html", "ace/mode/sh", "ace/mode/sh", "ace/mode/xml", "ace/mode/css"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var CstyleBehaviour = require2("./behaviour/cstyle").CstyleBehaviour;
      var TextMode = require2("./text").Mode;
      var MarkdownHighlightRules = require2("./markdown_highlight_rules").MarkdownHighlightRules;
      var MarkdownFoldMode = require2("./folding/markdown").FoldMode;
      var Mode = function() {
        this.HighlightRules = MarkdownHighlightRules;
        this.createModeDelegates({
          javascript: require2("./javascript").Mode,
          html: require2("./html").Mode,
          bash: require2("./sh").Mode,
          sh: require2("./sh").Mode,
          xml: require2("./xml").Mode,
          css: require2("./css").Mode
        });
...
export default require_mode_markdown();
//# sourceMappingURL=ace-builds_src-noconflict_mode-markdown.js.map
