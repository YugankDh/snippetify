...
// node_modules/ace-builds/src-noconflict/mode-vue.js
var require_mode_vue = __commonJS({
  "node_modules/ace-builds/src-noconflict/mode-vue.js"(exports, module) {
    ...
    ace.define("ace/mode/coffee_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      ...
      exports2.CoffeeHighlightRules = CoffeeHighlightRules;
    });
    ace.define("ace/mode/stylus_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/css_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      var CssHighlightRules = require2("./css_highlight_rules");
      ...
      exports2.StylusHighlightRules = StylusHighlightRules;
    });
    ace.define("ace/mode/scss_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules", "ace/mode/css_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var lang = require2("../lib/lang");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      ...
      exports2.ScssHighlightRules = ScssHighlightRules;
    });
    ace.define("ace/mode/sass_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/scss_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var lang = require2("../lib/lang");
      var ScssHighlightRules = require2("./scss_highlight_rules").ScssHighlightRules;
      ...
      exports2.SassHighlightRules = SassHighlightRules;
    });
    ace.define("ace/mode/less_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/css_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      var CssHighlightRules = require2("./css_highlight_rules");
        ...
        this.$rules = {
          "start": [
            ...
            },
            {
              token: "keyword",
              regex: "&"
              // special case - always treat as keyword
            },
            {
              token: keywordMapper,
              regex: "\\-?[@a-z_][@a-z0-9_\\-]*"
      ...
      exports2.LessHighlightRules = LessHighlightRules;
    });
    ace.define("ace/mode/slim_highlight_rules", ["require", "exports", "module", "ace/config", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var modes = require2("../config").$modes;
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      ...
      exports2.SlimHighlightRules = SlimHighlightRules;
    });
    ace.define("ace/mode/markdown_highlight_rules", ["require", "exports", "module", "ace/config", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules", "ace/mode/html_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var modes = require2("../config").$modes;
      var oop = require2("../lib/oop");
      var lang = require2("../lib/lang");
      ...
      var MarkdownHighlightRules = function() {
        ...
        this.addRules({
          ...
          "listblock": [
            ...
            {
              defaultToken: "list"
              //do not use markup.list to allow stling leading `*` differntly
            }
          ],
          "blockquote": [{
            token: "empty_line",
      ...
      exports2.MarkdownHighlightRules = MarkdownHighlightRules;
    });
    ace.define("ace/mode/jade_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/markdown_highlight_rules", "ace/mode/scss_highlight_rules", "ace/mode/less_highlight_rules", "ace/mode/coffee_highlight_rules", "ace/mode/javascript_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      var MarkdownHighlightRules = require2("./markdown_highlight_rules").MarkdownHighlightRules;
      var SassHighlightRules = require2("./scss_highlight_rules").ScssHighlightRules;
      var LessHighlightRules = require2("./less_highlight_rules").LessHighlightRules;
      var CoffeeHighlightRules = require2("./coffee_highlight_rules").CoffeeHighlightRules;
      var JavaScriptHighlightRules = require2("./javascript_highlight_rules").JavaScriptHighlightRules;
    ...
    ace.define("ace/mode/vue_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/css_highlight_rules", "ace/mode/typescript_highlight_rules", "ace/mode/coffee_highlight_rules", "ace/mode/html_highlight_rules", "ace/mode/javascript_highlight_rules", "ace/mode/stylus_highlight_rules", "ace/mode/sass_highlight_rules", "ace/mode/scss_highlight_rules", "ace/mode/less_highlight_rules", "ace/tokenizer", "ace/mode/slim_highlight_rules", "ace/mode/jade_highlight_rules", "ace/mode/javascript"], function(require2, exports2, module2) {
      ...
      var HtmlHighlightRules = require2("./html_highlight_rules").HtmlHighlightRules;
      var JavaScriptHighlightRules = require2("./javascript_highlight_rules").JavaScriptHighlightRules;
      var StylusHighlightRules = require2("./stylus_highlight_rules").StylusHighlightRules;
      var SassHighlightRules = require2("./sass_highlight_rules").SassHighlightRules;
      var ScssHighlightRules = require2("./scss_highlight_rules").ScssHighlightRules;
      var LessHighlightRules = require2("./less_highlight_rules").LessHighlightRules;
      var Tokenizer = require2("../tokenizer").Tokenizer;
      var SlimHighlightRules = require2("./slim_highlight_rules").SlimHighlightRules;
      var JadeHighlightRules = require2("./jade_highlight_rules").JadeHighlightRules;
      var JavaScriptMode = require2("./javascript").Mode;
      ...
      exports2.VueHighlightRules = VueHighlightRules;
    });
    ace.define("ace/mode/vue", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/html", "ace/lib/lang", "ace/mode/behaviour/xml", "ace/mode/html_completions", "ace/mode/html", "ace/mode/vue_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var HtmlFoldMode = require2("./folding/html").FoldMode;
      var lang = require2("../lib/lang");
      ...
      var VueHighlightRules = require2("./vue_highlight_rules").VueHighlightRules;
      var voidElements = [
        "area",
        "base",
        "br",
...
export default require_mode_vue();
//# sourceMappingURL=ace-builds_src-noconflict_mode-vue.js.map
