...
var require_mode_ejs = __commonJS({
  "node_modules/ace-builds/src-noconflict/mode-ejs.js"(exports, module) {
    ...
    ace.define("ace/mode/ruby_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      var constantOtherSymbol = exports2.constantOtherSymbol = {
      ...
      var constantNumericHex = exports2.constantNumericHex = {
        token: "constant.numeric",
        // hex
        regex: "0[xX][0-9a-fA-F](?:[0-9a-fA-F]|_(?=[0-9a-fA-F]))*\\b"
      };
      var constantNumericBinary = exports2.constantNumericBinary = {
        token: "constant.numeric",
        regex: /\b(0[bB][01](?:[01]|_(?=[01]))*)\b/
      };
      var constantNumericDecimal = exports2.constantNumericDecimal = {
        token: "constant.numeric",
        regex: /\b(0[dD](?:[1-9](?:[\d]|_(?=[\d]))*|0))\b/
      };
      var constantNumericOctal = exports2.constantNumericOctal = {
        token: "constant.numeric",
        regex: /\b(0[oO]?(?:[1-7](?:[0-7]|_(?=[0-7]))*|0))\b/
      };
      var constantNumericRational = exports2.constantNumericRational = {
        token: "constant.numeric",
        //rational + complex
        regex: /\b([\d]+(?:[./][\d]+)?ri?)\b/
      };
      var constantNumericComplex = exports2.constantNumericComplex = {
        token: "constant.numeric",
        //simple complex numbers
        regex: /\b([\d]i)\b/
      };
      var constantNumericFloat = exports2.constantNumericFloat = {
        token: "constant.numeric",
        // float + complex
        regex: "[+-]?\\d(?:\\d|_(?=\\d))*(?:(?:\\.\\d(?:\\d|_(?=\\d))*)?(?:[eE][+-]?\\d+)?)?i?\\b"
      };
      var instanceVariable = exports2.instanceVariable = {
      ...
      var RubyHighlightRules = function() {
        ...
        var keywordMapper = this.$keywords = this.createKeywordMapper({
          ...
          // TODO is this a remnant from js mode?
        }, "identifier");
      ...
      exports2.RubyHighlightRules = RubyHighlightRules;
    });
    ace.define("ace/mode/folding/ruby", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range", "ace/token_iterator"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../../lib/oop");
      var BaseFoldMode = require2("./fold_mode").FoldMode;
      var Range = require2("../../range").Range;
    ...
    ace.define("ace/mode/ruby", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/ruby_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/folding/ruby"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var RubyHighlightRules = require2("./ruby_highlight_rules").RubyHighlightRules;
      var MatchingBraceOutdent = require2("./matching_brace_outdent").MatchingBraceOutdent;
      var Range = require2("../range").Range;
      var FoldMode = require2("./folding/ruby").FoldMode;
      var Mode = function() {
    ...
    ace.define("ace/mode/ejs", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html_highlight_rules", "ace/mode/javascript_highlight_rules", "ace/lib/oop", "ace/mode/html", "ace/mode/javascript", "ace/mode/css", "ace/mode/ruby"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var HtmlHighlightRules = require2("./html_highlight_rules").HtmlHighlightRules;
      var JavaScriptHighlightRules = require2("./javascript_highlight_rules").JavaScriptHighlightRules;
      ...
      exports2.EjsHighlightRules = EjsHighlightRules;
      var oop = require2("../lib/oop");
      var HtmlMode = require2("./html").Mode;
      var JavaScriptMode = require2("./javascript").Mode;
      var CssMode = require2("./css").Mode;
      var RubyMode = require2("./ruby").Mode;
      var Mode = function() {
        HtmlMode.call(this);
...
export default require_mode_ejs();
//# sourceMappingURL=ace-builds_src-noconflict_mode-ejs.js.map
