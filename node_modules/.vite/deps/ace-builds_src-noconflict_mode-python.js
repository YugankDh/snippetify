...
var require_mode_python = __commonJS({
  "node_modules/ace-builds/src-noconflict/mode-python.js"(exports, module) {
    ace.define("ace/mode/python_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      ...
      exports2.PythonHighlightRules = PythonHighlightRules;
    });
    ...
    ace.define("ace/mode/python", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/python_highlight_rules", "ace/mode/folding/pythonic", "ace/range"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var PythonHighlightRules = require2("./python_highlight_rules").PythonHighlightRules;
      var PythonFoldMode = require2("./folding/pythonic").FoldMode;
...
export default require_mode_python();
//# sourceMappingURL=ace-builds_src-noconflict_mode-python.js.map
